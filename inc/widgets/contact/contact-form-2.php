...
add_filter('widgets_init', array('LTP_Widget_Contact_Form_2', 'register_widget'));

class LTP_Widget_Contact_Form_2 extends Kopa_Widget {

    public $kpb_group = 'contact';

    public static function register_widget($blocks){
        register_widget('LTP_Widget_Contact_Form_2');
    }

	public function __construct() {
		$this->widget_cssclass    = 'kopa-form-widget s2';
		$this->widget_description = esc_html__( 'Display contact form without description ( use contact page ).', 'luxicar-lite-toolkit' );
		$this->widget_id          = 'luxicar-toolkit-plus-widget-contact-form-2';
		$this->widget_name        = esc_html__( 'Luxicar - Contact Form 2', 'luxicar-lite-toolkit' );
		$this->settings 		  = array(
			'title'  => array(         
				'type'  => 'text',
				'std'   => '',
