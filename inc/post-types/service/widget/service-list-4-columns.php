...
add_action( 'kpb_get_widgets_list', array('LTP_Widget_Service_Lists_4_Column', 'register_block'));
	
class LTP_Widget_Service_Lists_4_Column extends Kopa_Widget {

	public $kpb_group = 'service';
	
	public static function register_block($blocks){
       	$blocks['LTP_Widget_Service_Lists_4_Column'] = new LTP_Widget_Service_Lists_4_Column();
        return $blocks;
    }
    
	public function __construct() {
		$this->widget_cssclass    = 'kopa-service-widget-2';
		$this->widget_description = esc_html__( 'Display service list 4 columns.', 'luxicar-lite-toolkit' );
		$this->widget_id          = 'lucixcar-toolkit-plus-widget-service-lists-4-columns';
		$this->widget_name        = esc_html__( 'Luxicar - Service List 4 Columns', 'luxicar-lite-toolkit' );
		$this->settings 		  = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
							...
							<article class="entry-item col-xs-12 col-md-3">
								<?php if(has_post_thumbnail()) : ?>
									<div class="entry-thumb">
										...
										<?php the_post_thumbnail('luxicar-widget-270x310'); ?>
										</a>
									</div>
								<?php endif; ?>
